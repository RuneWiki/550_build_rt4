...
final class Class120_Sub14_Sub5 extends NodeSub {
	...
	public static void method1439(final int i) {
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("fg.D(").append(i).append(')').toString());
		}
	}

	static final void method1440(final int i, final int i_0_, final int i_1_, final boolean bool, final int i_2_, final int i_3_, final int i_4_, final int i_5_, final byte i_6_, final int i_7_, final int i_8_) {
		do {
			try {
				if (Class100.selfPlayer.getSize() == 2) {
					...
					Class120_Sub14_Sub11.method1518(i_5_, i_8_, i, i_2_, i_4_, 26109, i_7_, i_3_, i_1_, Class100.selfPlayer.getSize(), i_0_, bool);
				} else {
				...
				throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("fg.A(").append(i).append(',').append(i_0_).append(',').append(i_1_).append(',').append(bool).append(',').append(i_2_).append(',').append(i_3_).append(',').append(i_4_).append(',').append(i_5_).append(',')
						.append(i_6_).append(',').append(i_7_).append(',').append(i_8_).append(')').toString());
			}
		} while (false);
	}
	...
	static final void method1441(final int i) {
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("fg.B(").append(i).append(')').toString());
		}
	}
	...
	static final int method1442(final byte i, final int i_12_, int i_13_, final int i_14_) {
		...
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("fg.C(").append(i).append(',').append(i_12_).append(',').append(i_13_).append(',').append(i_14_).append(')').toString());
		}
		return i_15_;
	}
