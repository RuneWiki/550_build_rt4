...
final class Class134 {
	...
	static final String method1949(final boolean bool, final int i, final boolean bool_0_) {
		...
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("pj.B(").append(bool).append(',').append(i).append(',').append(bool_0_).append(')').toString());
		}
		return string;
	}
	...
	public static void method1950(final int i) {
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("pj.A(").append(i).append(')').toString());
		}
	}
}
