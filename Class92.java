...
final class Class92 {
	...
	static final void method767(final int i) {
		try {
			...
			throw EnumType.method1428(runtimeexception, new StringBuilder("k.C(").append(i).append(')').toString());
		}
	}
	...
	static final void method768(final int i, final int i_16_, final int i_17_, final int i_18_, final int i_19_, final byte i_20_, final int i_21_, final int i_22_) {
		try {
			final int i_23_ = Class3.method83(Class120_Sub30_Sub2.anInt3699, i_22_, 1, IdentityKit.anInt1334);
			if (i_20_ < 60) {
				anInt864 = -63;
			}
			final int i_24_ = Class3.method83(Class120_Sub30_Sub2.anInt3699, i, 1, IdentityKit.anInt1334);
			final int i_25_ = Class3.method83(Class32.anInt260, i_19_, 1, ParamType.anInt3544);
			final int i_26_ = Class3.method83(Class32.anInt260, i_21_, 1, ParamType.anInt3544);
			final int i_27_ = Class3.method83(Class120_Sub30_Sub2.anInt3699, i_22_ - -i_16_, 1, IdentityKit.anInt1334);
			final int i_28_ = Class3.method83(Class120_Sub30_Sub2.anInt3699, -i_16_ + i, 1, IdentityKit.anInt1334);
			...
			final int i_31_ = Class3.method83(Class32.anInt260, i_19_ - -i_16_, 1, ParamType.anInt3544);
			final int i_32_ = Class3.method83(Class32.anInt260, -i_16_ + i_21_, 1, ParamType.anInt3544);
			...
			throw EnumType.method1428(runtimeexception, new StringBuilder("k.B(").append(i).append(',').append(i_16_).append(',').append(i_17_).append(',').append(i_18_).append(',').append(i_19_).append(',').append(i_20_).append(',').append(i_21_).append(',').append(i_22_).append(')')
					.toString());
		}
	}
}
