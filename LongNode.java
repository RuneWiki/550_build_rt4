...
final class LongNode extends Node {
	...
	static final boolean method1055(final int i, final int i_0_, final boolean bool_1_, final int i_2_, final GroundTile[][][] class120_sub18s) {
		...
		while (i_5_ != i_6_) {
			...
			if (bool_13_) {
				if (Class134.anIntArray1284[i] < SubInterface.activeTileHeightMap[Class173.gameLevel + 1][i_7_][i_12_]) {
					Class134.anIntArray1284[i] = SubInterface.activeTileHeightMap[Class173.gameLevel + 1][i_7_][i_12_];
				}
