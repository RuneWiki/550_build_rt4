...
final class Class60 implements Interface2 {
	...
	private final void method552() {
		...
		gl.glBindProgramARB(34336, anInt2176);
		gl.glEnable(34336);
		gl.glEndList();
		...
		gl.glDisable(Class78.aBoolean685 ? 32879 : 3553);
		gl.glActiveTexture(33984);
	...
	public final void method5(final int i) {
		if (anInt2175 >= 0) {
			...
			gl.glActiveTexture(33985);
			if ((i & 0x80) == 0) {
				gl.glEnable(Class78.aBoolean685 ? 32879 : 3553);
			} else {
				gl.glDisable(Class78.aBoolean685 ? 32879 : 3553);
			}
			gl.glActiveTexture(33984);
			if ((i & 0x40) == 0) {
				gl.glGetFloatv(2899, aFloatArray2178, 0);
				gl.glProgramLocalParameter4fvARB(34336, 66, aFloatArray2178, 0);
			} else {
	...
	public final void method3() {
		if (anInt2175 >= 0) {
			...
			gl.glMatrixMode(5888);
			if (!Class78.aBoolean685) {
				gl.glBindTexture(3553, Class78.anIntArray682[(int) (HDToolkit.anInt542 * 64 * 0.005F) % 64]);
			}
			gl.glActiveTexture(33984);
			if (anInt2179 != HDToolkit.anInt542) {
				int i = (HDToolkit.anInt542 & 0xff) * 256;
				for (int i_1_ = 0; i_1_ < 64; i_1_++) {
					aFloatBuffer2177.position(i);
					gl.glProgramLocalParameter4fvARB(34336, i_1_, aFloatBuffer2177);
					i += 4;
				}
				if (Class78.aBoolean685) {
					gl.glProgramLocalParameter4fARB(34336, 65, HDToolkit.anInt542 * 0.005F, 0.0F, 0.0F, 1.0F);
				} else {
					gl.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
				}
				anInt2179 = HDToolkit.anInt542;
			}
		}
	}

	public Class60() {
		if (anInt2175 < 0 && HDToolkit.aBoolean550 && HDToolkit.anInt526 >= 2) {
			final int[] is = new int[1];
			final GL gl = HDToolkit.gl;
			gl.glGenProgramsARB(1, is, 0);
			anInt2176 = is[0];
			final int[][] is_2_ = Class126.method1887(256, -87, 4, 0, 64, 3, 0.4F, 8, false);
			final int[][] is_3_ = Class126.method1887(256, 120, 4, 8, 64, 3, 0.4F, 8, false);
