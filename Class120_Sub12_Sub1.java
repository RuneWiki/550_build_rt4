...
final class Class120_Sub12_Sub1 extends Class120_Sub12 {
	...
	static final void method1195(final int i, final int i_1_, final int i_2_, final int i_3_) {
		for (int i_4_ = 0; i_4_ < Class120_Sub1.anInt2414; i_4_++) {
			if (i_2_ < Class160.anIntArray1495[i_4_] - -Class120_Sub16.anIntArray2608[i_4_] && i_2_ + i > Class160.anIntArray1495[i_4_] && Class120_Sub12_Sub38.anIntArray3441[i_4_] + Class69_Sub3_Sub1.anIntArray3081[i_4_] > i_3_ && i_3_ + i_1_ > Class120_Sub12_Sub38.anIntArray3441[i_4_]) {
				Class52.aBooleanArray467[i_4_] = true;
			}
		}
	}

	@Override
	final int[] method1187(final int i, final int i_5_) {
		int[] is;
		try {
			final int[] is_6_ = this.aClass30_2563.method258(i_5_, -118);
			if (i != -1735) {
				return null;
			}
			if (this.aClass30_2563.aBoolean238) {
				int i_7_ = 0;
				final int[][] is_8_ = this.aClass30_2563.method257(-1);
				int i_9_ = 0;
				int i_10_ = 0;
				int i_11_ = 0;
				int i_12_ = 0;
				...
				for (;;) {
					int i_23_ = i_15_ - -Class28.method244(random, -i_15_ + i_18_, -128);
					int i_24_ = Class28.method244(random, -i_17_ + i_19_, -92) + i_17_;
						...
						if (i_27_ != i_12_) {
							...
							for (int i_35_ = 0; i_35_ <= i_29_; i_35_++) {
								...
								if (i_37_ != i_26_) {
									...
									method1198(-i_37_ + i_26_, i_41_ + -i_40_, i_11_ + i_40_, i_37_, -1, random, is_8_);
								}
							}
						}
						i_12_ = i_27_;
					...
					if (i_25_ != Class120_Sub12_Sub7.anInt3178) {
						...
						is_42_[0] = i_10_;
						method1198(i_24_, i_23_, i_9_ + i_10_, i_26_, i ^ 0x6c6, random, is_8_);
						i_10_ = i_25_;
					} else {
						method1198(i_24_, i_23_, i_10_ - -i_9_, i_26_, -1, random, is_8_);
						if (bool_14_) {
							break;
						}
						bool = false;
						...
						i_9_ = Class28.method244(random, Class120_Sub12_Sub7.anInt3178, 105);
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("ac.D(").append(i).append(',').append(i_5_).append(')').toString());
		}
		return is;
	}
	...
	static final Frame goFullscreen(int bitDepth, final int width, final int height, final int refreshRate, final Signlink signlink) {
		...
		if (bitDepth == 0) {
			final DisplayModeInfo[] displayModes = Class120_Sub14_Sub2.getDisplayModes(signlink);
	...
	public static void method1197(final boolean bool) {
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("ac.U(").append(bool).append(')').toString());
		}
	}
	...
	private final void method1198(final int i, final int i_55_, int i_56_, final int i_57_, final int i_58_, final Random random, final int[][] is) {
		try {
			final int i_59_ = anInt3129 > 0 ? 4096 + -Class28.method244(random, anInt3129, 104) : 4096;
			final int i_60_ = anInt3130 * anInt3127 >> 12;
			final int i_61_ = anInt3130 + -((i_60_ ^ 0xffffffff) < i_58_ ? Class28.method244(random, i_60_, 105) : 0);
			...
			if (i_61_ > 0) {
						...
						if (i_65_ > i_68_) {
							...
							if (anInt3128 != 0) {
								for (int i_71_ = 0; i_71_ < i_64_; i_71_++) {
									...
									is_69_[Class120_Sub12_Sub3.method1207(i_71_ + i_56_, Class32.anInt259)] = is_69_[Class120_Sub12_Sub3.method1207(-1 + -i_71_ + i_55_ + i_56_, Class32.anInt259)] = i_70_ <= i_72_ ? i_70_ : i_72_;
								}
							} else {
								for (int i_73_ = 0; i_64_ > i_73_; i_73_++) {
									final int i_74_ = i_59_ * i_73_ / i_64_;
									is_69_[Class120_Sub12_Sub3.method1207(Class32.anInt259, i_73_ + i_56_)] = is_69_[Class120_Sub12_Sub3.method1207(i_56_ + i_55_ - (i_73_ + 1), Class32.anInt259)] = i_74_ * i_70_ >> 12;
								}
							}
							if (i_66_ - -i_67_ > Class120_Sub12_Sub7.anInt3178) {
								final int i_75_ = -i_66_ + Class120_Sub12_Sub7.anInt3178;
								Class4.method91(is_69_, i_66_, i_75_, i_70_);
								Class4.method91(is_69_, 0, i_67_ + -i_75_, i_70_);
							} else {
								Class4.method91(is_69_, i_66_, i_67_, i_70_);
							}
						} else {
							...
							if (i_65_ > i_76_) {
								...
								if (anInt3128 != 0) {
									for (int i_78_ = 0; i_64_ > i_78_; i_78_++) {
										...
										is_69_[Class120_Sub12_Sub3.method1207(Class32.anInt259, i_78_ + i_56_)] = is_69_[Class120_Sub12_Sub3.method1207(Class32.anInt259, -i_78_ + i_56_ - -i_55_ - 1)] = i_77_ > i_79_ ? i_79_ : i_77_;
									}
								} else {
									for (int i_80_ = 0; i_80_ < i_64_; i_80_++) {
										final int i_81_ = i_80_ * i_59_ / i_64_;
										is_69_[Class120_Sub12_Sub3.method1207(Class32.anInt259, i_56_ - -i_80_)] = is_69_[Class120_Sub12_Sub3.method1207(-1 + -i_80_ + i_55_ + i_56_, Class32.anInt259)] = i_77_ * i_81_ >> 12;
									}
								}
								if (Class120_Sub12_Sub7.anInt3178 < i_67_ + i_66_) {
									final int i_82_ = -i_66_ + Class120_Sub12_Sub7.anInt3178;
									Class4.method91(is_69_, i_66_, i_82_, i_77_);
									Class4.method91(is_69_, 0, i_67_ + -i_82_, i_77_);
								} else {
									Class4.method91(is_69_, i_66_, i_67_, i_77_);
								}
							} else {
								for (int i_83_ = 0; i_83_ < i_64_; i_83_++) {
									is_69_[Class120_Sub12_Sub3.method1207(Class32.anInt259, i_56_ - -i_83_)] = is_69_[Class120_Sub12_Sub3.method1207(Class32.anInt259, -i_83_ + i_55_ + i_56_ + -1)] = i_59_ * i_83_ / i_64_;
								}
								if (i_66_ - -i_67_ <= Class120_Sub12_Sub7.anInt3178) {
									Class4.method91(is_69_, i_66_, i_67_, i_59_);
								} else {
									final int i_84_ = -i_66_ + Class120_Sub12_Sub7.anInt3178;
									Class4.method91(is_69_, i_66_, i_84_, i_59_);
									Class4.method91(is_69_, 0, -i_84_ + i_67_, i_59_);
								}
							}
						}
					}
				...
				for (int i_85_ = 0; i > i_85_; i_85_++) {
					Class4.method91(is[i_85_ + i_57_], i_56_, i_55_, i_59_);
				}
			} else {
				final int i_86_ = Class120_Sub12_Sub7.anInt3178 - i_56_;
				for (int i_87_ = 0; i_87_ < i; i_87_++) {
					final int[] is_88_ = is[i_87_ + i_57_];
					Class4.method91(is_88_, i_56_, i_86_, i_59_);
					Class4.method91(is_88_, 0, -i_86_ + i_55_, i_59_);
				}
			}
		} catch (final RuntimeException runtimeexception) {
			throw Class120_Sub14_Sub2.method1428(runtimeexception,
					new StringBuilder("ac.R(").append(i).append(',').append(i_55_).append(',').append(i_56_).append(',').append(i_57_).append(',').append(i_58_).append(',').append(random != null ? "{...}" : "null").append(',').append(is != null ? "{...}" : "null").append(')').toString());
		}
	}

	static final int method1199(final int i, final int i_89_, final boolean bool) {
		int i_90_;
		try {
			if (bool) {
				return 42;
			...
			if (i_89_ < 0 || i_89_ >= class120_sub17.anIntArray2618.length) {
				return -1;
			}
			i_90_ = class120_sub17.anIntArray2618[i_89_];
		} catch (final RuntimeException runtimeexception) {
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("ac.S(").append(i).append(',').append(i_89_).append(',').append(bool).append(')').toString());
		}
		return i_90_;
	}
	...
	static final int method1200(final int i, final int i_91_) {
		...
		try {
			...
			if (i_91_ != 1624671788) {
				method1199(-15, 12, false);
			}
			i_92_ = InterfaceClickMask.method1688(106, i);
		} catch (final RuntimeException runtimeexception) {
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("ac.T(").append(i).append(',').append(i_91_).append(')').toString());
		}
		return i_92_;
	}
	...
	final void method1180(final byte i, final Buffer class120_sub7, final int i_93_) {
		while_111_: do {
			try {
				...
				throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("ac.M(").append(i).append(',').append(class120_sub7 != null ? "{...}" : "null").append(',').append(i_93_).append(')').toString());
			}
		} while (false);
	}
}
