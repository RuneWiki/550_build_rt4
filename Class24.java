...
final class Class24 {
	...
	static final void method205(final int i) {
		try {
			...
			if ((Class69.anInt616 ^ 0xffffffff) != 0) {
				Class120_Sub12_Sub32.method1372(i + -1, Class69.anInt616);
			}
			for (Class120_Sub26 class120_sub26 = (Class120_Sub26) Class120_Sub12_Sub13.aClass75_3234.method657(i + 13292); class120_sub26 != null; class120_sub26 = (Class120_Sub26) Class120_Sub12_Sub13.aClass75_3234.method658((byte) -70)) {
			...
			for (int i_11_ = 0; i_11_ < 25; i_11_++) {
				Class180.anIntArray1783[i_11_] = 0;
				Class172.anIntArray1720[i_11_] = 0;
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("cg.E(").append(i).append(')').toString());
		}
	}
