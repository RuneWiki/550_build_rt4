		...
		try {
			...
			if (i_21_ < -100) {
				for (/**/; i_28_ < class189s.length; i_28_++) {
					...
					if (jagexInterface != null && (i_20_ == jagexInterface.anInt2029 || (i_20_ ^ 0xffffffff) == 1412584498 && jagexInterface == Class120_Sub12_Sub4.aClass189_3156)) {
						int i_29_;
						if ((i_22_ ^ 0xffffffff) == 0) {
							Class160.anIntArray1495[Class120_Sub1.anInt2414] = jagexInterface.anInt2073 + i;
							Class120_Sub12_Sub38.anIntArray3441[Class120_Sub1.anInt2414] = i_26_ + jagexInterface.anInt1938;
						...
						if (!jagexInterface.aBoolean2041 || !client.method59(jagexInterface)) {
							...
							int i_30_ = jagexInterface.anInt1974;
							int i_31_ = jagexInterface.anInt1938 + i_26_;
							int i_32_ = jagexInterface.anInt2073 - -i;
							if (Class120_Sub30_Sub1.aBoolean3673 && (client.method54(jagexInterface).anInt2662 != 0 || jagexInterface.anInt1995 == 0) && i_30_ > 127) {
								i_30_ = 127;
							}
							...
							if (!jagexInterface.aBoolean2041 || i_37_ < i_36_ && i_38_ > i_35_) {
								if (jagexInterface.anInt1975 != 0) {
									if (jagexInterface.anInt1975 == 1337 || jagexInterface.anInt1975 == 1403) {
										Class56.anInt497 = i_32_;
										InputStream_Sub1.aClass189_26 = jagexInterface;
										Class120_Sub14_Sub16.anInt3590 = i_31_;
										StringNode.method1721(0, i_32_, jagexInterface.anInt2059, jagexInterface.anInt1975 == 1403, jagexInterface.anInt1948, i_31_);
									...
									if (jagexInterface.anInt1975 == 1338) {
											...
											if ((AbstractGraphicsBuffer.anInt1175 == 0 || AbstractGraphicsBuffer.anInt1175 == 3) && !Class15.menuOpen && Class115.anInt1110 >= i_37_ && i_35_ <= Class120_Sub12_Sub21.anInt3298 && i_36_ > Class115.anInt1110 && Class120_Sub12_Sub21.anInt3298 < i_38_) {
												...
												if (i_43_ <= i_41_ && i_41_ <= jagexInterface.anIntArray1949[i_42_] + i_43_) {
													...
													if (Class88.aBoolean828 && (0x40 & GroundTile.anInt2652) != 0) {
														final JagexInterface class189_51_ = Class120_Sub13.method1404(AbstractMouseWheelHandler.anInt119, (byte) 82, JagexSocket.anInt420);
									...
									if (jagexInterface.anInt1975 == 1339) {
										if (jagexInterface.method2501(-1)) {
									...
									if (jagexInterface.anInt1975 == 1400) {
									...
									if (jagexInterface.anInt1975 == 1401) {
									...
									if (jagexInterface.anInt1975 == 1402) {
										if (!HDToolkit.glEnabled) {
									...
									if (jagexInterface.anInt1975 == 1405) {
										if (Class85.showFps) {
									...
									if (jagexInterface.anInt1975 == 1406) {
								...
								if (!Class15.menuOpen) {
									if (jagexInterface.anInt1995 == 0 && jagexInterface.aBoolean1960 && i_37_ <= Class115.anInt1110 && Class120_Sub12_Sub21.anInt3298 >= i_35_ && Class115.anInt1110 < i_36_ && i_38_ > Class120_Sub12_Sub21.anInt3298 && !Class120_Sub30_Sub1.aBoolean3673) {
								...
								if (jagexInterface.anInt1995 == 0) {
									...
									if (!jagexInterface.aBoolean2041) {
										if (-jagexInterface.anInt2059 + jagexInterface.anInt1937 < jagexInterface.anInt2021) {
									...
									if (HDToolkit.glEnabled && jagexInterface.anInt1975 == 1407) {
										Class34.method283(i_32_, i_31_, jagexInterface.anInt1948, jagexInterface.anInt2059);
									}
									method2008(i_32_ + -jagexInterface.anInt2023, jagexInterface.bitPacked, (byte) -105, i_29_, class189s, i_38_, i_36_, i_35_, -jagexInterface.anInt2021 + i_31_, i_37_);
									if (jagexInterface.aClass189Array2072 != null) {
										method2008(-jagexInterface.anInt2023 + i_32_, jagexInterface.bitPacked, (byte) -108, i_29_, jagexInterface.aClass189Array2072, i_38_, i_36_, i_35_, -jagexInterface.anInt2021 + i_31_, i_37_);
									}
								...
								if (Class9.aBooleanArray74[i_29_] || Class15.anInt96 > 1) {
									if (jagexInterface.anInt1995 == 0 && !jagexInterface.aBoolean2041 && jagexInterface.anInt2059 < jagexInterface.anInt1937) {
										PlayerAppearance.method2039(jagexInterface.anInt2059, (byte) 80, jagexInterface.anInt1948 + i_32_, jagexInterface.anInt1937, i_31_, jagexInterface.anInt2021);
									}
									if (jagexInterface.anInt1995 != 1) {
										if (jagexInterface.anInt1995 == 2) {
											int i_63_ = 0;
											for (int i_64_ = 0; jagexInterface.anInt2060 > i_64_; i_64_++) {
												for (int i_65_ = 0; jagexInterface.anInt2014 > i_65_; i_65_++) {
													int i_66_ = i_31_ + (32 + jagexInterface.anInt2077) * i_64_;
													int i_67_ = i_32_ + i_65_ * (32 - -jagexInterface.anInt2044);
													if (i_63_ < 20) {
														i_66_ += jagexInterface.anIntArray1986[i_63_];
														i_67_ += jagexInterface.anIntArray1988[i_63_];
													}
													if (jagexInterface.anIntArray1978[i_63_] > 0) {
														final int i_68_ = jagexInterface.anIntArray1978[i_63_] - 1;
														if (i_67_ - -32 > i_27_ && i_67_ < i_24_ && i_25_ < 32 + i_66_ && i_66_ < i_23_ || jagexInterface == Class180_Sub4.aClass189_2954 && Class5.anInt2154 == i_63_) {
															...
															if (Light.anInt393 != 1 || i_63_ != Class108_Sub1.anInt2319 || jagexInterface.bitPacked != Class141.anInt1355) {
																class120_sub14_sub19 = Class187.method2477(jagexInterface.anIntArray1983[i_63_], 1, jagexInterface.aBoolean1956, (byte) -94, null, i_68_, 3153952);
															} else {
																class120_sub14_sub19 = Class187.method2477(jagexInterface.anIntArray1983[i_63_], 2, jagexInterface.aBoolean1956, (byte) -127, null, i_68_, 0);
															}
													...
													} else if (jagexInterface.anIntArray1957 != null && i_63_ < 20) {
										...
										} else if (jagexInterface.anInt1995 == 3) {
											int i_76_;
											if (!Class120_Sub12_Sub35.method1382(jagexInterface, (byte) -121)) {
												i_76_ = jagexInterface.anInt2025;
												if (CursorType.aClass189_1243 == jagexInterface && jagexInterface.anInt2081 != 0) {
													i_76_ = jagexInterface.anInt2081;
												}
											} else {
												i_76_ = jagexInterface.anInt1972;
												if (CursorType.aClass189_1243 == jagexInterface && jagexInterface.anInt2087 != 0) {
													i_76_ = jagexInterface.anInt2087;
												}
											}
											if (i_30_ == 0) {
												if (!jagexInterface.aBoolean2019) {
													if (!HDToolkit.glEnabled) {
											...
											} else if (jagexInterface.aBoolean2019) {
												if (HDToolkit.glEnabled) {
													GraphicsHD.method590(i_32_, i_31_, jagexInterface.anInt1948, jagexInterface.anInt2059, i_76_, -(i_30_ & 0xff) + 256);
												} else {
													GraphicsLD.method2159(i_32_, i_31_, jagexInterface.anInt1948, jagexInterface.anInt2059, i_76_, 256 - (0xff & i_30_));
												}
											} else if (!HDToolkit.glEnabled) {
												GraphicsLD.drawRect(i_32_, i_31_, jagexInterface.anInt1948, jagexInterface.anInt2059, i_76_, -(0xff & i_30_) + 256);
											} else {
												GraphicsHD.method583(i_32_, i_31_, jagexInterface.anInt1948, jagexInterface.anInt2059, i_76_, 256 - (i_30_ & 0xff));
											}
										} else if (jagexInterface.anInt1995 == 4) {
											...
											if (class120_sub14_sub8 == null) {
												...
												String string = jagexInterface.aString1950;
												int i_77_;
												if (!Class120_Sub12_Sub35.method1382(jagexInterface, (byte) -105)) {
													i_77_ = jagexInterface.anInt2025;
													if (jagexInterface == CursorType.aClass189_1243 && jagexInterface.anInt2081 != 0) {
														i_77_ = jagexInterface.anInt2081;
													}
												} else {
													i_77_ = jagexInterface.anInt1972;
													if (jagexInterface == CursorType.aClass189_1243 && jagexInterface.anInt2087 != 0) {
														i_77_ = jagexInterface.anInt2087;
													}
													if (jagexInterface.aString1936.length() > 0) {
														string = jagexInterface.aString1936;
													}
												}
												...
												if (!jagexInterface.aBoolean2041) {
													string = InputStream_Sub1.method71(jagexInterface, 2, string);
												}
												class120_sub14_sub8.method1462(string, i_32_, i_31_, jagexInterface.anInt1948, jagexInterface.anInt2059, i_77_, !jagexInterface.aBoolean2040 ? -1 : 0, jagexInterface.anInt2011, jagexInterface.anInt2009, jagexInterface.anInt2057);
											}
										} else if (jagexInterface.anInt1995 == 5) {
											if (!jagexInterface.aBoolean2041) {
												final AbstractSprite class120_sub14_sub19 = jagexInterface.method2492(Class120_Sub12_Sub35.method1382(jagexInterface, (byte) -115), (byte) -18);
												if (class120_sub14_sub19 == null) {
													if (Class88.aBoolean835) {
														InterfaceClickMask.redrawInterface(jagexInterface);
													}
												...
												if (jagexInterface.anInt2030 == -1) {
													class120_sub14_sub19 = jagexInterface.method2492(false, (byte) -18);
												} else if (jagexInterface.aBoolean2097 && Class100.selfPlayer.appearance != null) {
													class120_sub14_sub19 = Class187.method2477(jagexInterface.anInt2075, jagexInterface.anInt2090, jagexInterface.aBoolean1956, (byte) -63, Class100.selfPlayer.appearance, jagexInterface.anInt2030, jagexInterface.anInt2026);
												} else {
													class120_sub14_sub19 = Class187.method2477(jagexInterface.anInt2075, jagexInterface.anInt2090, jagexInterface.aBoolean1956, (byte) -115, null, jagexInterface.anInt2030, jagexInterface.anInt2026);
												}
												if (class120_sub14_sub19 != null) {
													...
													if (jagexInterface.aBoolean2001) {
														...
														if (HDToolkit.glEnabled) {
															...
															for (int i_87_ = 0; i_80_ > i_87_; i_87_++) {
																for (int i_88_ = 0; i_88_ < i_81_; i_88_++) {
																	if (jagexInterface.anInt2070 != 0) {
																		class120_sub14_sub19.method1590(i_31_ - -(i_88_ * i_79_) + i_79_ / 2, (byte) -99, jagexInterface.anInt2070, i_87_ * i_78_ + i_32_ - -(i_78_ / 2), 4096);
																	} else if (i_30_ == 0) {
														...
														if (jagexInterface.anInt2070 != 0) {
															class120_sub14_sub19.method1590(i_31_ + jagexInterface.anInt2059 / 2, (byte) -99, jagexInterface.anInt2070, jagexInterface.anInt1948 / 2 + i_32_, i_89_);
														} else if (i_30_ != 0) {
											...
											if ((jagexInterface.anInt2030 ^ 0xffffffff) != 0) {
												...
												if (objType != null) {
													...
													if (jagexInterface.aBoolean2097 && Class100.selfPlayer.appearance != null) {
														class180_sub7 = objType.method2105(jagexInterface.anInt1946, 1, -115, jagexInterface.anInt2098, Class100.selfPlayer.appearance, class40, jagexInterface.anInt1965);
													} else {
														class180_sub7 = objType.method2105(jagexInterface.anInt1946, 1, -78, jagexInterface.anInt2098, null, class40, jagexInterface.anInt1965);
													}
											...
											} else if (jagexInterface.anInt2031 != 5) {
												if ((i_90_ ^ 0xffffffff) != 0) {
													final Class40 class40 = Class120_Sub30_Sub2.method1763(i_90_, 122);
													class180_sub7 = jagexInterface.method2486(class40, Class100.selfPlayer.appearance, jagexInterface.anInt2098, (byte) -83, jagexInterface.anInt1946, jagexInterface.anInt1965, bool);
													if (class180_sub7 == null && Class88.aBoolean835) {
														InterfaceClickMask.redrawInterface(jagexInterface);
													}
												} else {
													class180_sub7 = jagexInterface.method2486(null, Class100.selfPlayer.appearance, -1, (byte) -83, -1, 0, bool);
													if (class180_sub7 == null && Class88.aBoolean835) {
														InterfaceClickMask.redrawInterface(jagexInterface);
													}
												}
											} else if ((jagexInterface.anInt1961 ^ 0xffffffff) != 0) {
												int i_92_ = jagexInterface.anInt1961 & 0x7ff;
												...
												if (class180_sub5_sub1 != null && (int) Class70.stringToLong(class180_sub5_sub1.aString3745) << 11 == (~0x7ff & jagexInterface.anInt1961)) {
													class180_sub7 = class180_sub5_sub1.appearance.method2040(null, 0, -1, -1, null, jagexInterface.anInt1946, -7453, false, 0, class40, true, 0);
												}
											} else {
											...
											if (class180_sub7 != null) {
												...
												final int i_95_ = i_31_ - -(jagexInterface.anInt2059 / 2) - -(jagexInterface.anInt2008 * i_94_ >> 8);
												final int i_96_ = (jagexInterface.anInt1981 * i_93_ >> 8) + jagexInterface.anInt1948 / 2 + i_32_;
												if (!HDToolkit.glEnabled) {
													Rasterizer.method869(i_96_, i_95_);
													final int i_97_ = jagexInterface.anInt2005 * Rasterizer.cosineTable[jagexInterface.anInt2047] >> 16;
													final int i_98_ = Rasterizer.sineTable[jagexInterface.anInt2047] * jagexInterface.anInt2005 >> 16;
													if (jagexInterface.aBoolean2041) {
														if (jagexInterface.aBoolean2046) {
															((Class180_Sub7_Sub1) class180_sub7).method2400(0, jagexInterface.anInt2091, jagexInterface.anInt1935, jagexInterface.anInt2047, jagexInterface.anInt2076, i_98_ - -i_91_ - -jagexInterface.anInt1977, i_97_ + jagexInterface.anInt1977, jagexInterface.anInt2005);
														} else {
															class180_sub7.method2367(0, jagexInterface.anInt2091, jagexInterface.anInt1935, jagexInterface.anInt2047, jagexInterface.anInt2076, i_91_ + i_98_ - -jagexInterface.anInt1977, i_97_ - -jagexInterface.anInt1977, -1L);
														}
													} else {
														class180_sub7.method2367(0, jagexInterface.anInt2091, 0, jagexInterface.anInt2047, 0, i_98_, i_97_, -1L);
													}
													...
													if (!jagexInterface.aBoolean2046) {
														...
														HDToolkit.method512(i_96_, i_95_, jagexInterface.anInt2005, jagexInterface.aShort2093, i_93_, i_94_);
													}
													HDToolkit.method532();
													...
													final int i_99_ = Rasterizer.cosineTable[jagexInterface.anInt2047] * jagexInterface.anInt2005 >> 16;
													final int i_100_ = jagexInterface.anInt2005 * Rasterizer.sineTable[jagexInterface.anInt2047] >> 16;
													if (jagexInterface.aBoolean2041) {
														class180_sub7.method2367(0, jagexInterface.anInt2091, jagexInterface.anInt1935, jagexInterface.anInt2047, jagexInterface.anInt2076, jagexInterface.anInt1977 + i_91_ + i_100_, i_99_ + jagexInterface.anInt1977, -1L);
													} else {
														class180_sub7.method2367(0, jagexInterface.anInt2091, 0, jagexInterface.anInt2047, 0, i_100_, i_99_, -1L);
													}
													if (jagexInterface.aBoolean2003) {
														HDToolkit.method505();
													}
											...
											if (jagexInterface.anInt1995 == 7) {
												...
												int i_101_ = 0;
												for (int i_102_ = 0; i_102_ < jagexInterface.anInt2060; i_102_++) {
													for (int i_103_ = 0; jagexInterface.anInt2014 > i_103_; i_103_++) {
														if (jagexInterface.anIntArray1978[i_101_] > 0) {
															final ObjType objType = ObjType.list(jagexInterface.anIntArray1978[i_101_] + -1);
															String string;
															if (objType.stackable != 1 && jagexInterface.anIntArray1983[i_101_] == 1) {
																string = new StringBuilder("<col=ff9040>").append(objType.name).append("</col>").toString();
															} else {
																string = new StringBuilder("<col=ff9040>").append(objType.name).append("</col> x").append(Node.method1033((byte) 126, jagexInterface.anIntArray1983[i_101_])).toString();
															}
															final int i_104_ = i_32_ + i_103_ * (115 + jagexInterface.anInt2044);
															final int i_105_ = (jagexInterface.anInt2077 + 12) * i_102_ + i_31_;
															if (jagexInterface.anInt2011 == 0) {
																class120_sub14_sub8.method1466(string, i_104_, i_105_, jagexInterface.anInt2025, !jagexInterface.aBoolean2040 ? -1 : 0);
															} else if (jagexInterface.anInt2011 == 1) {
																class120_sub14_sub8.method1478(string, i_104_ + 57, i_105_, jagexInterface.anInt2025, !jagexInterface.aBoolean2040 ? -1 : 0);
															} else {
																class120_sub14_sub8.method1482(string, i_104_ + 114, i_105_, jagexInterface.anInt2025, !jagexInterface.aBoolean2040 ? -1 : 0);
															}
														}
														i_101_++;
													}
											...
											if (jagexInterface.anInt1995 == 8 && Class49.aClass189_441 == jagexInterface && Class108.anInt1031 == Class120_Sub12_Sub21.anInt3291) {
												int i_106_ = 0;
												...
												string = jagexInterface.aString1950;
												string = InputStream_Sub1.method71(jagexInterface, 2, string);
												while (string.length() > 0) {
											...
											if (jagexInterface.anInt1995 == 9) {
												...
												if (jagexInterface.anInt1967 == 1) {
													if (HDToolkit.glEnabled) {
														GraphicsHD.method582(i_116_, i_119_, i_117_, i_118_, jagexInterface.anInt2025);
													} else {
														GraphicsLD.method2150(i_116_, i_119_, i_117_, i_118_, jagexInterface.anInt2025);
													}
												} else if (HDToolkit.glEnabled) {
													GraphicsHD.method586(i_116_, i_119_, i_117_, i_118_, jagexInterface.anInt2025, jagexInterface.anInt1967);
												} else {
													GraphicsLD.method2161(i_116_, i_119_, i_117_, i_118_, jagexInterface.anInt2025, jagexInterface.anInt1967);
												}
											}
										}
									}
