...
final class PlayerAppearance {
	...
	static final void method2033(final int i) {
		try {
			...
			Class120_Sub12_Sub31.aClass21_3378.method186((byte) 86);
	...
	final void method2036(final byte i, final int i_5_, final int i_6_) {
		try {
			...
			if (anIntArray1376[i_7_] != 0 && Class74.method653(-27169, i_6_) != null) {
	...
	private final void method2038(final int i) {
		try {
			...
			if (l != 0L && aLong1365 != l) {
				Class43.aClass21_367.method187(l, 882);
			}
		} catch (final RuntimeException runtimeexception) {
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("qk.K(").append(i).append(')').toString());
		}
	}
	...
	static final void method2039(final int i, final byte i_10_, final int i_11_, final int i_12_, final int i_13_, final int i_14_) {
		try {
			...
			if (!HDToolkit.glEnabled) {
				...
				GraphicsLD.fillRect(i_11_, 16 + i_13_ - -i_16_, 16, i_15_, Class46.anInt414);
				...
				GraphicsHD.fillRect(i_11_, i_13_ - (-16 + -i_16_), 16, i_15_, Class46.anInt414);
	...
	final Class180_Sub7 method2040(final Class150[] class150s, final int i, final int i_17_, final int i_18_, final Class40 class40, final int i_19_, final int i_20_, final boolean bool, final int i_21_, final Class40 class40_22_, final boolean bool_23_, final int i_24_) {
		...
		try {
			...
			Class180_Sub7 class180_sub7_26_ = (Class180_Sub7) Class43.aClass21_367.method193(l, (byte) -101);
			if (class180_sub7_26_ == null) {
				...
				for (int i_28_ = 0; i_28_ < 12; i_28_++) {
					...
					} else if ((~0x7fffffff & i_29_) != 0 && !Class74.method653(-27169, i_29_ & 0x3fffffff).method1990((byte) -106)) {
						bool_27_ = true;
					}
				}
				if (bool_27_) {
					if (aLong1374 != -1L) {
						class180_sub7_26_ = (Class180_Sub7) Class43.aClass21_367.method193(aLong1374, (byte) 37);
					}
					if (class180_sub7_26_ == null) {
						return null;
					}
				...
				if (class180_sub7_26_ == null) {
					...
					for (int i_30_ = 0; i_30_ < 12; i_30_++) {
						...
						if ((i_31_ & 0x40000000) != 0) {
							...
							final Class180_Sub2 class180_sub2 = Class74.method653(-27169, 0x3fffffff & i_31_).method1986((byte) 86);
							if (class180_sub2 != null) {
								class180_sub2s[i_30_] = class180_sub2;
							}
						}
					...
					if (bool_23_) {
						Class43.aClass21_367.method185(-128, class180_sub7_26_, l);
						aLong1374 = l;
					}
				}
			}
			...
			for (int i_54_ = 0; i_53_ > i_54_; i_54_++) {
				if (class150s[i_54_] != null) {
					...
					if (class40_55_.anIntArray342 != null) {
						bool_49_ = true;
						Class120_Sub18.aClass40Array2649[i_54_] = class40_55_;
						...
						if (!class40_55_.aBoolean332 && !Class164.aBoolean1586 || i_57_ == -1 || class40_55_.anIntArray342.length <= i_57_) {
			...
			if (class40_22_ != null) {
				...
				if ((class40_22_.aBoolean332 || Class164.aBoolean1586) && i_17_ != -1 && i_17_ < class40_22_.anIntArray342.length) {
			...
			if (class40 != null) {
				...
				if ((class40.aBoolean332 || Class164.aBoolean1586) && (i_18_ ^ 0xffffffff) != 0 && i_18_ < class40.anIntArray342.length) {
			...
			while (i_53_ > i_74_) {
				if (Class120_Sub21.aClass120_Sub14_Sub18Array2667[i_74_] != null) {
					class180_sub7_73_.method2384(Class120_Sub21.aClass120_Sub14_Sub18Array2667[i_74_], Class73.anIntArray664[i_74_], Class120_Sub15.aClass120_Sub14_Sub18Array2595[i_74_], Class120_Sub14_Sub10.anIntArray3533[i_74_], -1 + Class71.anIntArray627[i_74_],
							Class120_Sub12_Sub26.anIntArray3325[i_74_], i_75_, Class120_Sub18.aClass40Array2649[i_74_].aBoolean341, anIntArrayArray1377[i_74_]);
				}
				i_74_++;
				i_75_ <<= 1;
			}
			...
			for (i_74_ = 0; i_74_ < i_53_; i_74_++) {
				...
				Class120_Sub18.aClass40Array2649[i_74_] = null;
			}
	...
	final Class180_Sub7 method2041(final int i, final Class40 class40, final int i_76_, final int i_77_, final int i_78_, final int i_79_, final int i_80_, final int i_81_) {
		...
		try {
			...
			Class180_Sub7 class180_sub7_82_ = (Class180_Sub7) Class90.aClass21_840.method193(l, (byte) 36);
			if (class180_sub7_82_ == null) {
				int i_83_ = 0;
				final Class180_Sub2[] class180_sub2s = new Class180_Sub2[3];
				if (!Class74.method653(i + -27163, i_80_).method1993(-32390) || !Class74.method653(-27169, i_76_).method1993(i + -32384) || !Class74.method653(-27169, i_77_).method1993(i ^ 0x7e80)) {
					return null;
				}
				Class180_Sub2 class180_sub2 = Class74.method653(-27169, i_80_).method1985(-116);
				if (class180_sub2 != null) {
					class180_sub2s[i_83_++] = class180_sub2;
				}
				class180_sub2 = Class74.method653(-27169, i_76_).method1985(-104);
				if (class180_sub2 != null) {
					class180_sub2s[i_83_++] = class180_sub2;
				}
				class180_sub2 = Class74.method653(-27169, i_77_).method1985(-115);
				if (class180_sub2 != null) {
					class180_sub2s[i_83_++] = class180_sub2;
				}
				...
				Class90.aClass21_840.method185(-128, class180_sub7_82_, l);
			}
			if (class40 != null) {
	...
	final void method2042(final int i, final int i_85_, int[] is, final int i_86_, final int[] is_87_, final boolean bool) {
		try {
			if (anInt1366 != i_86_) {
				anInt1366 = i_86_;
			...
			if (is == null) {
				...
				for (int i_88_ = 0; i_88_ < 8; i_88_++) {
					for (int i_89_ = 0; Class7.anInt61 > i_89_; i_89_++) {
						final Class139 class139 = Class74.method653(-27169, i_89_);
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("qk.J(").append(i).append(',').append(i_85_).append(',').append(is != null ? "{...}" : "null").append(',').append(i_86_).append(',').append(is_87_ != null ? "{...}" : "null").append(',').append(bool).append(')')
					.toString());
		}
	}
	...
	final Class180_Sub7 method2044(final int i, final Class40 class40, final int i_91_, final byte i_92_, final int i_93_) {
		...
		try {
			...
			Class180_Sub7 class180_sub7_94_ = (Class180_Sub7) Class90.aClass21_840.method193(aLong1365, (byte) 35);
			if (class180_sub7_94_ == null) {
				boolean bool = false;
				for (int i_95_ = 0; i_95_ < 12; i_95_++) {
					final int i_96_ = anIntArray1376[i_95_];
					if ((i_96_ & 0x40000000) == 0) {
						if ((~0x7fffffff & i_96_) != 0 && !Class74.method653(-27169, i_96_ & 0x3fffffff).method1993(-32390)) {
							bool = true;
						}
				...
				for (int i_98_ = 0; i_98_ < 12; i_98_++) {
					...
					if ((0x40000000 & i_99_) != 0) {
						...
						final Class180_Sub2 class180_sub2 = Class74.method653(-27169, 0x3fffffff & i_99_).method1985(-103);
						if (class180_sub2 != null) {
							class180_sub2s[i_97_++] = class180_sub2;
						}
					}
				...
				Class90.aClass21_840.method185(-128, class180_sub7_94_, aLong1365);
			}
			if (class40 != null) {
				class180_sub7_94_ = class40.method323(false, i, i_91_, class180_sub7_94_, i_93_);
			}
			if (i_92_ <= 52) {
				method2042(100, 96, null, -54, null, false);
			}
