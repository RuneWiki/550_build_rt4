...
final class Class43 {
	...
	static Class21 aClass21_367;
	static int anInt368;

	static {
		aByteArrayArray365 = new byte[50][];
		usingJavaAbove5 = false;
		aClass21_367 = new Class21(260);
	}

	static final void method338(final int i, final int i_0_, final int i_1_) {
		try {
			Class120_Sub12_Sub14.aClass21_3238 = new Class21(i);
			Class82.aClass21_786 = new Class21(i_0_);
			if (i_1_ > -35) {
				method344((byte) -118);
			}
	...
	static final Class27 method339(final int i, final int i_2_) {
		Class27 class27;
		try {
			Class27 class27_3_ = (Class27) Class120_Sub14_Sub11.aClass21_3541.method193(i, (byte) -89);
			if (class27_3_ != null) {
				return class27_3_;
			}
			if (i_2_ != -9609) {
			...
			final byte[] is = Class180_Sub6.aClass50_3056.method442(Class101_Sub1.method841(i_2_ ^ ~0x25ab, i), (byte) 125, Class120_Sub29.method1728(i, i_2_ ^ 0x25ca));
			class27_3_ = new Class27();
			if (is != null) {
				class27_3_.method237(new Buffer(is), (byte) 58);
			}
			Class120_Sub14_Sub11.aClass21_3541.method185(-126, class27_3_, i);
			class27 = class27_3_;
		} catch (final RuntimeException runtimeexception) {
	...
	static final void method340(final int i) {
		try {
			if (i < -57) {
				Class120_Sub14_Sub13.aClass21_3564.method190(false);
			}
		} catch (final RuntimeException runtimeexception) {
	...
	static final void method341(final int i, final int i_4_) {
		try {
			...
			Class120_Sub12_Sub35.aClass21_3411.method192((byte) 63, i);
		} catch (final RuntimeException runtimeexception) {
	...
	static final void method342(final int i) {
		try {
			if (i == -6086) {
				Node.aClass189ArrayArray1150 = new Class189[Class101_Sub4.aClass50_2301.method421(-34)][];
				Class57.aBooleanArray503 = new boolean[Class101_Sub4.aClass50_2301.method421(i ^ 0x17fa)];
			}
		} catch (final RuntimeException runtimeexception) {
	...
	static final void method343(final int i, final int i_5_, final int i_6_, final byte i_7_, final int i_8_, final int i_9_, final int i_10_, final int i_11_, final int i_12_) {
		try {
			...
			if (!Class50.method434(-48, i)) {
				...
				Class142.method2008(i_8_, -1, (byte) -119, i_12_, Node.aClass189ArrayArray1150[i], i_9_, i_11_, i_5_, i_6_, i_10_);
			}
		} catch (final RuntimeException runtimeexception) {
	...
	static final void method346(final int i, final Buffer class120_sub7) {
		try {
			final int i_14_ = class120_sub7.method1081((byte) 98);
			Class148.aClass151Array1400 = new Class151[i_14_];
			for (int i_15_ = 0; i_15_ < i_14_; i_15_++) {
				Class148.aClass151Array1400[i_15_] = new Class151();
				Class148.aClass151Array1400[i_15_].anInt1418 = class120_sub7.method1081((byte) 98);
				Class148.aClass151Array1400[i_15_].aString1422 = class120_sub7.method1135(6072);
			}
			Class120_Sub26.anInt2738 = class120_sub7.method1081((byte) 98);
			if (i == -31081) {
				Class120_Sub14_Sub2.anInt3454 = class120_sub7.method1081((byte) 98);
				Class57.anInt502 = class120_sub7.method1081((byte) 98);
				...
				for (int i_16_ = 0; i_16_ < Class57.anInt502; i_16_++) {
					final int i_17_ = class120_sub7.method1081((byte) 98);
