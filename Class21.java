...
final class Class21 {
	...
	final int method184(final boolean bool) {
		...
		try {
			...
			for (Class120_Sub14_Sub3 class120_sub14_sub3 = (Class120_Sub14_Sub3) aClass177_126.peekFirst(); class120_sub14_sub3 != null; class120_sub14_sub3 = (Class120_Sub14_Sub3) aClass177_126.peekNext()) {
				if (!class120_sub14_sub3.method1430(-1249071392)) {
					i_0_++;
				}
			}
			i = i_0_;
		} catch (final RuntimeException runtimeexception) {
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("cc.F(").append(bool).append(')').toString());
		}
		return i;
	}

	final void method185(final int i, final Object object, final long l) {
		try {
			method187(l, 882);
			if (i < -124) {
				if (anInt125 != 0) {
					...
					final Class120_Sub14_Sub3 class120_sub14_sub3 = (Class120_Sub14_Sub3) aClass177_126.removeFirst();
					class120_sub14_sub3.unlink();
					class120_sub14_sub3.unlinkSub();
				}
				final Class120_Sub14_Sub3_Sub1 class120_sub14_sub3_sub1 = new Class120_Sub14_Sub3_Sub1(object);
				aClass75_123.method655(class120_sub14_sub3_sub1, 95, l);
				aClass177_126.insertLast(class120_sub14_sub3_sub1);
				((Class120_Sub14_Sub3) class120_sub14_sub3_sub1).subUid = 0L;
			}
		} catch (final RuntimeException runtimeexception) {
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("cc.B(").append(i).append(',').append(object != null ? "{...}" : "null").append(',').append(l).append(')').toString());
		}
	}

	final void method186(final byte i) {
		try {
			aClass177_126.clear();
			aClass75_123.method662((byte) -102);
			if (i != 86) {
				method194(null, false, -39);
			}
			anInt125 = anInt127;
		} catch (final RuntimeException runtimeexception) {
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("cc.A(").append(i).append(')').toString());
		}
	}

	final void method187(final long l, final int i) {
		try {
			final Class120_Sub14_Sub3 class120_sub14_sub3 = (Class120_Sub14_Sub3) aClass75_123.method659(l, -123);
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("cc.G(").append(l).append(',').append(i).append(')').toString());
		}
	}
	...
	final void method190(final boolean bool) {
		try {
			if (bool) {
				aClass120_Sub14_Sub8_121 = null;
			}
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("cc.I(").append(bool).append(')').toString());
		}
	}
	...
	final void method192(final byte i, final int i_3_) {
		try {
			if (Class125.aClass57_2147 != null) {
				for (Class120_Sub14_Sub3 class120_sub14_sub3 = (Class120_Sub14_Sub3) aClass177_126.peekFirst(); class120_sub14_sub3 != null; class120_sub14_sub3 = (Class120_Sub14_Sub3) aClass177_126.peekNext()) {
					if (!class120_sub14_sub3.method1430(-1249071392)) {
						if (++class120_sub14_sub3.subUid > i_3_) {
							final Class120_Sub14_Sub3 class120_sub14_sub3_4_ = Class125.aClass57_2147.method493(-91, class120_sub14_sub3);
							aClass75_123.method655(class120_sub14_sub3_4_, 87, class120_sub14_sub3.uid);
							Class120_Sub12_Sub15.method1275(class120_sub14_sub3, (byte) 116, class120_sub14_sub3_4_);
							class120_sub14_sub3.unlink();
							class120_sub14_sub3.unlinkSub();
						}
					} else if (class120_sub14_sub3.method1429(false) == null) {
						class120_sub14_sub3.unlink();
						class120_sub14_sub3.unlinkSub();
						anInt125++;
					}
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("cc.D(").append(i).append(',').append(i_3_).append(')').toString());
		}
	}
	...
	Class21(final int i) {
		...
		aClass75_123 = new Class75(i_5_);
	}

	final Object method193(final long l, final byte i) {
		Object object;
		try {
			final Class120_Sub14_Sub3 class120_sub14_sub3 = (Class120_Sub14_Sub3) aClass75_123.method659(l, -124);
			if (class120_sub14_sub3 == null) {
				return null;
			}
			final Object object_6_ = class120_sub14_sub3.method1429(false);
			if (object_6_ == null) {
				class120_sub14_sub3.unlink();
				class120_sub14_sub3.unlinkSub();
				anInt125++;
			...
			if (!class120_sub14_sub3.method1430(-1249071392)) {
				aClass177_126.insertLast(class120_sub14_sub3);
				class120_sub14_sub3.subUid = 0L;
			} else {
				final Class120_Sub14_Sub3_Sub1 class120_sub14_sub3_sub1 = new Class120_Sub14_Sub3_Sub1(object_6_);
				aClass75_123.method655(class120_sub14_sub3_sub1, 95, class120_sub14_sub3.uid);
				aClass177_126.insertLast(class120_sub14_sub3_sub1);
				((Class120_Sub14_Sub3) class120_sub14_sub3_sub1).subUid = 0L;
				class120_sub14_sub3.unlink();
				class120_sub14_sub3.unlinkSub();
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("cc.C(").append(l).append(',').append(i).append(')').toString());
		}
		return object;
	}
			...
			if (class120_sub14_sub12 != null) {
				...
				for (int i_10_ = 1; objects.length > i_10_; i_10_++) {
					if (objects[i_10_] instanceof Integer) {
						...
						if (i_11_ == -2147483645) {
							i_11_ = class120_sub10.aClass189_2534 != null ? class120_sub10.aClass189_2534.anInt1999 : -1;
						}
						if (-2147483644 == i_11_) {
						...
						if ((i_11_ ^ 0xffffffff) == 2147483641) {
							i_11_ = class120_sub10.aClass189_2532 != null ? class120_sub10.aClass189_2532.anInt1999 : -1;
						}
