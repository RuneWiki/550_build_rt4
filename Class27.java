...
final class Class27 {
	...
	static final void method240(final boolean bool, final int i) {
		try {
			...
			int i_3_ = GroundObjectNode.anInt3626;
			...
			Class120_Sub12_Sub30.method1363(57, i_8_, Class22.method197(Class173.gameLevel, Class100.selfPlayer.x, Class100.selfPlayer.z) + -50, i_5_, 3 * i_5_ + 600, Class120_Sub10.anInt2545, i, Class69_Sub3_Sub1.anInt3083);
			if (Class83.anInt792 == i_2_ && i_4_ == Class120_Sub12_Sub10.anInt3200 && i_3_ == GroundObjectNode.anInt3626 && Class128.anInt1223 == i_7_ && Class180_Sub3.anInt2909 == i_6_) {
				client.anInt2200 = 1;
			} else {
				...
				if (i_3_ < GroundObjectNode.anInt3626) {
					i_3_ += NpcType.anInt1660 + (-i_3_ + GroundObjectNode.anInt3626) * Class120_Sub17.anInt2621 / 1000;
					if (i_3_ < GroundObjectNode.anInt3626) {
						GroundObjectNode.anInt3626 = i_3_;
					}
				}
				if (GroundObjectNode.anInt3626 < i_3_) {
					i_3_ -= NpcType.anInt1660 - -((-GroundObjectNode.anInt3626 + i_3_) * Class120_Sub17.anInt2621 / 1000);
					if (GroundObjectNode.anInt3626 < i_3_) {
						GroundObjectNode.anInt3626 = i_3_;
					}
				}
