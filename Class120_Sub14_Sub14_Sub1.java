...
final class Class120_Sub14_Sub14_Sub1 extends Class120_Sub14_Sub14 {
	...
	public static void method1543(final int i) {
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("al.B(").append(i).append(')').toString());
		}
	}

	static final void method1544(final int i, final byte i_0_, final int i_1_) {
		try {
			if (i_0_ != -68) {
				method1543(77);
			}
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("al.E(").append(i).append(',').append(i_0_).append(',').append(i_1_).append(')').toString());
		}
	}
	...
	final int method1537(final int i) {
		...
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("al.G(").append(i).append(')').toString());
		}
		return i_2_;
	}

	static final void method1545(final int i, final boolean bool, final boolean bool_3_, final boolean bool_4_) {
		try {
			for (int i_5_ = 0; i_5_ < Class148.localNpcCount; i_5_++) {
				...
				if (class180_sub5_sub2 != null && class180_sub5_sub2.isVisible() && class180_sub5_sub2.npcType.method2199(15835)) {
					final int i_6_ = class180_sub5_sub2.getSize();
					if (bool_4_) {
						if (!class180_sub5_sub2.npcType.aBoolean1706) {
							continue;
						}
					} else if (!class180_sub5_sub2.npcType.aBoolean1656 == bool_3_ || i != 0 && i != i_6_) {
						continue;
					}
					if (i_6_ != 1) {
						if (((0x1 & i_6_) != 0 || (0x7f & class180_sub5_sub2.x) == 0 && (class180_sub5_sub2.z & 0x7f) == 0) && ((i_6_ & 0x1) != 1 || (0x7f & class180_sub5_sub2.x) == 64 && (class180_sub5_sub2.z & 0x7f) == 64)) {
							int i_7_ = class180_sub5_sub2.x - 64 * i_6_ >> 7;
							int i_8_ = class180_sub5_sub2.z - i_6_ * 64 >> 7;
			...
			if (!bool) {
				method1546(-87, false, 104, (byte) 105);
			}
			int i_15_ = 0;
			for (/**/; i_15_ < Class148.localNpcCount; i_15_++) {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("al.D(").append(i).append(',').append(bool).append(',').append(bool_3_).append(',').append(bool_4_).append(')').toString());
		}
	}
	...
	static final void method1546(final int i, final boolean bool, final int i_28_, final byte i_29_) {
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("al.A(").append(i).append(',').append(bool).append(',').append(i_28_).append(',').append(i_29_).append(')').toString());
		}
	}
	...
	final byte[] method1535(final byte i) {
		...
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("al.C(").append(i).append(')').toString());
		}
		return is;
	}
}
