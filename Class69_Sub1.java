...
final class Class69_Sub1 extends Class69 {
	...
	static final boolean method618(final int i, final int i_0_, final int i_1_) {
		...
		if (Class120_Sub12_Sub34.method1380(i_3_ + 1, OverridedJInterface.tileHeightMap[i][i_0_][i_1_], i_4_ + 1) && Class120_Sub12_Sub34.method1380(i_3_ + 128 - 1, OverridedJInterface.tileHeightMap[i][i_0_ + 1][i_1_], i_4_ + 1)
				&& Class120_Sub12_Sub34.method1380(i_3_ + 128 - 1, OverridedJInterface.tileHeightMap[i][i_0_ + 1][i_1_ + 1], i_4_ + 128 - 1) && Class120_Sub12_Sub34.method1380(i_3_ + 1, OverridedJInterface.tileHeightMap[i][i_0_][i_1_ + 1], i_4_ + 128 - 1)) {
