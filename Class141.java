...
final class Class141 {
	...
	static final void method2001(final int i) {
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("qf.B(").append(i).append(')').toString());
		}
	}
	...
	public static void method2002(final int i) {
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("qf.C(").append(i).append(')').toString());
		}
	}

	Class141(final int i, final int i_2_, final int i_3_, final int i_4_, final int i_5_, final int i_6_, final boolean bool) {
		this.anInt1353 = i_4_;
		this.anInt1349 = i;
		this.anInt1348 = i_5_;
		this.anInt1346 = i_6_;
	...
	static final Class120_Sub12 method2003(final Buffer class120_sub7, final int i) {
		...
		try {
			...
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("qf.A(").append(class120_sub7 != null ? "{...}" : "null").append(',').append(i).append(')').toString());
		}
