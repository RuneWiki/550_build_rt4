...
final class Class120_Sub14_Sub6 extends NodeSub {
	...
	static final void method1445(final byte i) {
		try {
			if (AbstractGraphicsBuffer.anInt1157 != -1 && Class120_Sub12_Sub15.anInt3248 != -1) {
				...
				Class180_Sub3.anInt2909 = 0x7ff & (int) (Class193.aFloat2139 * 325.949);
				Class128.anInt1223 = 0x7ff & (int) (325.949 * Class120_Sub30_Sub1.aFloat3674);
			}
		} catch (final RuntimeException runtimeexception) {
			throw Class120_Sub14_Sub2.method1428(runtimeexception, new StringBuilder("fn.C(").append(i).append(')').toString());
		}
	}
	...
	static final void addMenuOption(final long l, final int i, final int i_26_, final String string, final String string_27_, final short i_28_, final int i_29_) {
		if (!Class15.menuOpen && Class186.anInt1906 < 500) {//TODO refactor menu options
			Class120_Sub12_Sub33.aStringArray3394[Class186.anInt1906] = string_27_;
			Class120_Sub12_Sub29.aStringArray3369[Class186.anInt1906] = string;
			InterfaceChangeNode.menuOptionsCursorId[Class186.anInt1906] = i_29_ == -1 ? Class192.anInt2123 : i_29_;
			Class120_Sub29.aShortArray2777[Class186.anInt1906] = i_28_;
			Class120_Sub12.aLongArray2562[Class186.anInt1906] = l;
			Class120_Sub12_Sub7.anIntArray3182[Class186.anInt1906] = i;
			Class120_Sub29.anIntArray2769[Class186.anInt1906] = i_26_;
			Class186.anInt1906++;
		}
	}
