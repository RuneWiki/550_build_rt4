...
final class Class120_Sub2_Sub1 extends Class120_Sub2 {
	...
	final void method1052(final int i, final int i_11_) {
		final GL gl = HDToolkit.gl;
		final int i_12_ = Deque.highestOneBit(i);
		final int i_13_ = Deque.highestOneBit(i_11_);
		if (anIntArray3110 != null) {
			...
			aClass131_3109 = LinkedShader
					.linkShaders(new GLShader[] { GLShader
							.compile(
									...
									GLShader.FRAGMENT_SHADER_ID) });
			aClass131_3104 = LinkedShader.linkShaders(new GLShader[] { GLShader.compile(
