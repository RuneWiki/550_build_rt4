...
final class Js5Request extends AbstractRequest {
		...
		if (class73 != null && class73.aBoolean633 && class73.method647()) {
			if (class73.anIntArray638 != null) {
				...
				for (int i_5_ = 0; i_5_ < is.length / 2; i_5_++) {
					...
					is[i_5_ * 2] = i_0_ + jagexInterface.width / 2 - -((i_3_ - -(class73.anIntArray638[1 + 2 * i_5_] * 4)) * i_8_ + i_7_ * (i_2_ - -(class73.anIntArray638[2 * i_5_] * 4)) >> 16);
					is[1 + 2 * i_5_] = i - (-(jagexInterface.height / 2) - -(-(i_8_ * (i_2_ + 4 * class73.anIntArray638[i_5_ * 2])) + i_7_ * (i_3_ + 4 * class73.anIntArray638[i_5_ * 2 + 1]) >> 16));
				}
	...
	static final void method1550(final int i) {
		try {
			...
			if (i != 1) {
				method1547(null, -28, -110, 25, -100, -93);
			}
		} catch (final RuntimeException runtimeexception) {
			throw EnumType.method1428(runtimeexception, new StringBuilder("ul.F(").append(i).append(')').toString());
		}
	}
	...
	static final Class145 method1551(final int i, final byte i_13_) {
		...
		try {
			...
			throw EnumType.method1428(runtimeexception, new StringBuilder("ul.H(").append(i).append(',').append(i_13_).append(')').toString());
		}
		return class145;
	}
	...
	static final void method1552(final boolean bool, final int i, final int i_15_, final int i_16_, final boolean bool_17_, final int i_18_, final int i_19_) {
		try {
			...
			throw EnumType.method1428(runtimeexception, new StringBuilder("ul.A(").append(bool).append(',').append(i).append(',').append(i_15_).append(',').append(i_16_).append(',').append(bool_17_).append(',').append(i_18_).append(',').append(i_19_).append(')').toString());
		}
	}
