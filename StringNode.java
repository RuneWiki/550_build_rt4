...
final class StringNode extends Node {
	...
	static final void method1721(final int i, int x, int height, final boolean bool, int width, int y) {
		...
		if (client.anInt2200 != 1) {
			...
			Class120_Sub12_Sub30.method1363(57, i_7_, -50 + Class22.method197(Class100.selfPlayer.z, true, Class100.selfPlayer.x, Class173.anInt1729), i_6_, 3 * i_6_ + 600, Class120_Sub10.anInt2545, height, Class69_Sub3_Sub1.anInt3083);
		}
		final int i_8_ = Class83.anInt792;
		final int i_9_ = Class120_Sub14_Sub21.anInt3626;
		...
		for (int i_13_ = i; i_13_ < 5; i_13_++) {
			if (Class120_Sub12_Sub12.aBooleanArray3223[i_13_]) {
				...
				if (i_13_ == 2) {
					Class120_Sub14_Sub21.anInt3626 += i_14_;
				}
				if (i_13_ == 0) {
		...
		if (!HDToolkit.glEnabled) {
			...
			if (Class109.gameState == 10) {
				i_16_ = Class120_Sub14_Sub18.method1581(Class120_Sub14_Sub14_Sub1.brightness, Class120_Sub14_Sub21.anInt3626 >> 10, Class120_Sub12_Sub22.anInt3301, Class83.anInt792 >> 10, true);
			} else {
		...
		if (!HDToolkit.glEnabled) {
			Class115.method1007(Class83.anInt792, Class120_Sub12_Sub10.anInt3200, Class120_Sub14_Sub21.anInt3626, Class128.anInt1223, Class180_Sub3.anInt2909, Class9.aByteArrayArrayArray70, Class134.anIntArray1284, Class54.anIntArray488, Class120_Sub32.anIntArray2787, Class180_Sub6.anIntArray3075, anIntArray2735, Class173.anInt1729 - -1, i_21_, Class100.selfPlayer.x >> 7, Class100.selfPlayer.z >> 7);
			Class120_Sub2.method1050();
			...
			Class91.method760(Class180_Sub3.anInt2909, Class128.anInt1223, Class120_Sub12_Sub10.anInt3200, Class120_Sub14_Sub21.anInt3626, 85, Class83.anInt792);
			HDToolkit.anInt542 = Class101_Sub2.loopCycle;
			Class115.method1007(Class83.anInt792, Class120_Sub12_Sub10.anInt3200, Class120_Sub14_Sub21.anInt3626, Class128.anInt1223, Class180_Sub3.anInt2909, Class9.aByteArrayArrayArray70, Class134.anIntArray1284, Class54.anIntArray488, Class120_Sub32.anIntArray2787, Class180_Sub6.anIntArray3075, anIntArray2735, 1 + Class173.anInt1729, i_21_, Class100.selfPlayer.x >> 7, Class100.selfPlayer.z >> 7);
		...
		Class120_Sub14_Sub21.anInt3626 = i_9_;
		...
		if (!bool && !Class69.aBoolean615 && !Class15.menuOpen && x <= Class115.anInt1110 && width + x > Class115.anInt1110 && y <= Class120_Sub12_Sub21.anInt3298 && y + height > Class120_Sub12_Sub21.anInt3298) {
			InterfaceChangeNode.method1452(height, Class115.anInt1110, y, x, width, -105, Class120_Sub12_Sub21.anInt3298);
		}
	}
