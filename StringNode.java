	...
	static final void method1721(final int i, int x, int height, final boolean titleScreen, int width, int y) {
		...
		if (!titleScreen) {
			...
			if (Class134.entityRenderPriority != 0) {
				for (int size = 1; size <= 5; size++) {
					...
					Class120_Sub14_Sub14_Sub1.method1545(size, false, false);
					Class120_Sub14_Sub14_Sub1.method1545(size, true, false);
				}
			} else {
				for (int size = 1; size <= 5; size++) {
					Class120_Sub14_Sub14_Sub1.method1545(size, false, false);
		...
		if (!HDToolkit.glEnabled) {
			...
			if (Class158.anInt1475 >= 0) {
				...
				class41.method330(Class132.anInt1257, x, y, width, height, OverlayType.renderPitch, Class180_Sub3.renderYaw, 0);
			} else {
			...
			if (Class158.anInt1475 >= 0) {
				...
				class41.method331(Class132.anInt1257, x, y, width, height, OverlayType.renderPitch, Class180_Sub3.renderYaw, i_16_);
			} else {
		...
		if (!HDToolkit.glEnabled) {
			...
			MouseRecorder.method760(Class180_Sub3.renderYaw, OverlayType.renderPitch, Class120_Sub12_Sub10.renderY, GroundObjectNode.renderZ, 85, Class83.renderX);
