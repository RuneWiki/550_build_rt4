...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener {
		...
		if (i_0_ >= 0) {
			...
			if (i_4_ == 24) {
				...
				if (class180_sub5_sub1 != null) {
					...
					Class120_Sub14_Sub5.method1440(Class100.selfPlayer.walkQueueX[0], 0, 0, true, class180_sub5_sub1.getSize(), i_2_, Class100.selfPlayer.walkQueueZ[0], 0, class180_sub5_sub1.getSize(), i_1_);
				}
			}
			if (i_4_ == 17) {
			...
			if (i_4_ == 33) {
				...
				if (class180_sub5_sub2 != null) {
					...
					Class120_Sub12_Sub11.outputStream.putByteC(!Class35.aBooleanArray299[82] ? 0 : 1);
					...
					Class120_Sub14_Sub5.method1440(Class100.selfPlayer.walkQueueX[0], 0, 0, true, class180_sub5_sub2.getSize(), i_2_, Class100.selfPlayer.walkQueueZ[0], 0, class180_sub5_sub2.getSize(), i_1_);
				}
			}
			if (i_4_ == 40) {
				IsaacCipher.crossY = Class120_Sub12_Sub36.lastClickY;
			...
			if (i_4_ == 46) {
				...
				Class120_Sub14_Sub5.method1440(Class100.selfPlayer.walkQueueX[0], 0, 0, true, 0, i_2_, Class100.selfPlayer.walkQueueZ[0], 0, 0, i_1_);
			}
			if (i_4_ == 21) {
				final Player class180_sub5_sub1 = Class118.playersList[i_3_];
				if (class180_sub5_sub1 != null) {
			...
			if (i_4_ == 25) {
				...
				if (class180_sub5_sub2 != null) {
					...
					Class120_Sub12_Sub11.outputStream.putLEShortA(i_3_);
					Class120_Sub12_Sub11.outputStream.putByteA(Class35.aBooleanArray299[82] ? 1 : 0);
					Class120_Sub14_Sub5.method1440(Class100.selfPlayer.walkQueueX[0], 0, 0, true, class180_sub5_sub2.getSize(), i_2_, Class100.selfPlayer.walkQueueZ[0], 0, class180_sub5_sub2.getSize(), i_1_);
				}
			}
			if (i_4_ == 1007) {
			...
			if (i_4_ == 4) {
				...
				Class120_Sub12_Sub11.outputStream.putByteC(Class35.aBooleanArray299[82] ? 1 : 0);
				Class120_Sub12_Sub11.outputStream.putLEShortA(GameEntity.currentBaseX + i_1_);
			...
			if (i_4_ == 47) {
				if (i_3_ == 0) {
					...
					Class120_Sub12_Sub20.method1302(Class173.gameLevel, i_1_, i_2_);
				} else if (Class86.staffLevel <= 0 || !Class35.aBooleanArray299[82] || !Class35.aBooleanArray299[81]) {
			...
			if (i_4_ == 29) {
				...
				if (class180_sub5_sub1 != null) {
					...
					Class120_Sub12_Sub11.outputStream.putShortA(i_3_);
					Class120_Sub12_Sub11.outputStream.putByteA(!Class35.aBooleanArray299[82] ? 0 : 1);
					Class120_Sub14_Sub5.method1440(Class100.selfPlayer.walkQueueX[0], 0, 0, true, class180_sub5_sub1.getSize(), i_2_, Class100.selfPlayer.walkQueueZ[0], 0, class180_sub5_sub1.getSize(), i_1_);
				}
			}
			if (i_4_ == 11) {
			...
			if (i_4_ == 26) {
				if (i_3_ != 0) {
					if (i_3_ == 1) {
						if (Class86.staffLevel <= 0 || !Class35.aBooleanArray299[82] || !Class35.aBooleanArray299[81]) {
				...
				if (i_4_ == 34) {
					...
					if (i_4_ == 1001) {
						...
						if (jagexInterface == null || 100000 > jagexInterface.objAmounts[i_1_]) {
							...
							Class120_Sub14_Sub14.method1540("", 0, new StringBuilder(String.valueOf(jagexInterface.objAmounts[i_1_])).append(" x ").append(ObjType.list(i_3_).name).toString());
						}
						Class69_Sub2.anInt2236 = 0;
						Class32.aClass189_256 = Class74.getJagexInterface(i_2_);
						Huffman.anInt1204 = i_1_;
	...
	static final void constructSprites(final js5 js5) {
		...
		Class120_Sub14_Sub14_Sub1.prayerIconSprites = Class125.constructTransparentSprites(js5, 0, Class52.headiconsprayerId);
		...
		Cache.smallFont.setNameIcons(Class82.aClass107Array785, null);
		...
		final LDSprite[] class120_sub14_sub19_sub2s = Class115.constructLDSprites(js5, PlayerAppearance.hintmapedgeId, 0);
		for (int i_9_ = 0; class120_sub14_sub19_sub2s.length > i_9_; i_9_++) {
	...
	static final void method47(final int i, final boolean bool) {
		try {
			...
			throw EnumType.method1428(runtimeexception, new StringBuilder("ue.W(").append(i).append(',').append(bool).append(')').toString());
		}
	}
	...
	public final void destroy() {
		try {
			...
			throw EnumType.method1428(runtimeexception, "ue.destroy()");
		}
	}
	...
	public final String getParameter(final String string) {
		...
		try {
			...
			throw EnumType.method1428(runtimeexception, new StringBuilder("ue.getParameter(").append(string != null ? "{...}" : "null").append(')').toString());
		}
		return string_25_;
	}
}
