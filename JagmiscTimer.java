...
final class JagmiscTimer extends AbstractTimer {
	...
	private final long method741(final int i) {
		final long l = jagmisc.nanoTime();
		final long l_0_ = -aLong2258 + l;
		aLong2258 = l;
		long l_1_ = 0L;
		...
		for (int i_2_ = i; anInt2257 >= i_2_; i_2_++) {
	...
	JagmiscTimer() {
		...
		if (-1L == (aLong2254 ^ 0xffffffffffffffffL)) {
